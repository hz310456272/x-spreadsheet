...
function addDataConfiguration() {
  if (typeof this.addDataConfiguration === "function") {
    const { data } = this;
    const { ri, ci } = data.selector;
    this.addDataConfiguration(data.getCell(ri, ci), ri, ci);
  }
}
...
function sheetInitEvents() {
  ...
  contextMenu.itemClick = (type, cb) => {
    ...
    } else if (type === "select-data-configuration") {
      addDataConfiguration.call(this);
    } else {
